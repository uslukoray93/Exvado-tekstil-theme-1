    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-[#FF7A3D]">CANKO TEKSTİL</h3>
            <p className="text-gray-400 text-sm">
              1980'den beri metre ile toptan & perakende kumaş satışı. Kaliteli kumaşlar, uygun fiyatlar.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/faq" className="text-gray-400 hover:text-white">Sık Sorulan Sorular</Link></li>
              <li><Link href="/shipping" className="text-gray-400 hover:text-white">Kargo Bilgileri</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>Email: info@cankotekstil.com</li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy;2026 <span className="font-bold text-white">Exvado - Ecom</span> premium e-ticaret altyapısı ile hazırlandı.</p>
        </div>
      </div>
    </footer>
  );
